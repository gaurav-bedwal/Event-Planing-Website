            ...
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-4 md:mb-0">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="font-bold text-xl">Event Dashboard</span>
                    </div>
                    <p class="text-text-secondary text-sm">Organize and manage your events with ease</p>
                </div>
                ...
                <div class="flex flex-col items-center md:items-end">
                    ...
                    <p class="text-text-secondary text-sm">&copy; <?php echo date('Y'); ?> Event Dashboard. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
    
    <!-- Include modern UI enhancements -->
    <script src="js/modern-ui.js"></script>
    
    <!-- Include any additional scripts specified by the page -->
    <?php if (isset($extra_js)): ?>
        <?php echo $extra_js; ?>
    <?php endif; ?>
    
    <script>
        // Trigger notification system for any flash messages
